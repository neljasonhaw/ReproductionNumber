...
Let's say you want to stratify the Rt analysis by a certain variable. Using the dummy data, let us try to limit the analysis to Municipality C.
...
```{r rt_C, cache = TRUE, message = FALSE}
